...
<form action="<?php echo JRoute::_('index.php?option=com_jomoeasyrestaurantmenu&amp&id=' . $this->item->id); ?>" method="post" name="adminForm" class="form-validate" id="dish-form">
